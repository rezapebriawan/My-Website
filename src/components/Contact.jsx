            ...
            <div>
                <div className="text-gray-300 my-3">
                    ...
                    <p className="text-justify leading-7 w-11/12 mx-auto">
                      Saya seorang IT Engineer dengan ketertarikan besar di bidang system administration,
                      networking, dan cloud technologies. Saya juga berpengalaman dalam web development, 
                      aplikasi mobile development, serta memiliki keahlian dalam IoT engineering.
                    </p>
                </div>
